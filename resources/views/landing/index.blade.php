    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('register') }}"
                                class="btn btn-primary font-weight-bold ml-md-2">Daftar</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="hero-section">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <h1 class="mb-4">Raih Masa Depanmu <br><span class="text-primary-custom">bersama
                                    Learnova</span></h1>
                            <p class="lead mb-5 text-white">Belajar lebih cerdas, mengajar lebih mudah, dan memantau
                                perkembangan pembelajaran dalam satu platform.</p>
                            <div>
                                <a href="#catalog" class="btn btn-primary btn-lg mr-3 shadow">Jelajahi Kursus <i
                                        class="fas fa-arrow-right ml-2"></i></a>
                                <a href="{{ route('register') }}"
                                    class="btn btn-light btn-lg text-primary shadow mt-3 mt-sm-0">Daftar Sekarang</a>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-5 mt-lg-0 text-center">
                            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuD_6bJt0Pai42XEKuEdlpMV33zsWxZDK1-eBg-dZ1DhKx8RpPN8qYX3Km7OR7WwFb9Rjlizj-tSRa1alHx2NH5TZAXsvhYmzzAh4WH1r3RiBUI7bH1QqlbiIy5j6pbKhze4bm8S-mvHyqPmE4j_trpuYf24oWEOFzCVStYNfzpCFtuY41nLsRTIWpEZKRQB-ZV4bqT7-AKzFVVRtlEk6hektxaaHusurlURRZ3vhnfbzWCQOAHu8DZChGgD6mGxFhL1N_b9sxL7shU"
                                class="img-fluid rounded shadow-lg" alt="Hero Image" style="transform: rotate(2deg);">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="features" class="py-5 bg-white">
                <div class="container py-5">
                    <div class="text-center mb-5">
                        ...
                        <p class="lead text-muted mx-auto" style="max-width: 600px;">Kami menyediakan struktur dan
                            konten yang Anda butuhkan untuk memimpin karir Anda melalui metode pedagogis berbasis data.
                        </p>
                    </div>
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 shadow-sm border-0 bg-light">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <p class="text-muted">Kursus yang dirancang dan diajarkan oleh para pemimpin
                                        industri yang diakui, dari akademisi papan atas hingga praktisi teknologi
                                        terkemuka.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 shadow-sm border-0 bg-light">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <p class="text-muted">Belajar dengan jadwal Anda sendiri dengan akses seumur hidup
                                        ke semua materi di berbagai perangkat yang Anda miliki.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 shadow-sm border-0 bg-light">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <p class="text-muted">Dapatkan kredensial yang diakui dan diverifikasi oleh
                                        perusahaan global untuk meningkatkan otoritas profesional Anda.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="catalog" class="py-5 bg-light-custom">
                <div class="container py-5">
                    <div class="d-flex justify-content-between align-items-end mb-4">
                        <div>
                            <span class="text-primary font-weight-bold text-uppercase tracking-wide">Daftar
                                Sekarang</span>
                            <h2 class="font-weight-bold mt-2">Katalog Kursus Pilihan</h2>
                        </div>
                        <a href="{{ route('catalog') }}" class="font-weight-bold text-primary d-none d-sm-block">Lihat
                            Semua Katalog <i class="fas fa-chevron-right ml-1"></i></a>
                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="card h-100 shadow-sm border-0 course-card">
                                    <img src="{{ $course->thumbnail ? asset('storage/' . $course->thumbnail) : 'https://placehold.co/600x400?text=' . urlencode($course->title) }}"
                                        class="card-img-top" alt="Gambar Kursus">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text text-muted mb-4">
                                            {{ Str::limit(strip_tags($course->description), 100) }}</p>
                                        <div
                                            class="mt-auto border-top pt-3 d-flex justify-content-between align-items-center">
                                            <div class="text-muted">
                                                <i class="fas fa-clock mr-1"></i> {{ $course->duration_weeks ?? 0 }}
                                                Minggu
                                            </div>
                                            <a href="{{ route('course.preview', $course->id) }}"
                                                class="btn btn-outline-primary btn-sm font-weight-bold">Pratinjau</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 mb-5 mb-lg-0">
                            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuCKNUIdey5peYAUnW-bjUK4HPSSdYI_W4Timed6YaZtjlolPZnhZib9p0RsvzFrzdZirHmzKNvXUoTLA3Gd1TzsAmUtOsaEGjGwc4qfK4BlBkp8P742a_5ncrc0lgz0FWj50X4VhaX-bzKMhjFViwmRAiFdiwI6UN3I7YSuGir0qox15GJiGJHaVJZSJ5IyBp4UTX1p1GF1n5u2Eh-UDqN0HLg3FbjtPdkXx4Kid-QJK6AZIxxl3VTq6uUw8o7P5gse--RYrbcm5xQ"
                                class="img-fluid rounded shadow-lg" alt="Instruktur">
                        </div>
                        <div class="col-lg-6 offset-lg-1">
                            <span class="text-primary font-weight-bold text-uppercase tracking-wide">Sorotan
                                Instruktur</span>
                            <h2 class="font-weight-bold mt-3 mb-4">Belajar dari Ahli Global</h2>
                            <div class="p-4 bg-light rounded border-left border-primary shadow-sm mb-4"
                                style="border-left-width: 4px !important;">
                                <p class="font-italic text-muted mb-3">"Di EduCommand, kami tidak hanya mengajarkan
                                    teknologi; kami mengajarkan fondasi masa depan. Tujuan kami adalah memberikan setiap
                                    siswa alat bantu yang presisi untuk memimpin masa depan mereka sendiri."</p>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">Semua instruktur disaring oleh Dewan Akademik
                                                kami.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">Umpan balik langsung dari setiap instruktur
                                                kursus.</small>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="py-5 bg-white">
                <div class="container">
                    <div class="cta-section text-center position-relative overflow-hidden">
                        ...
                        <p class="lead mb-5 mx-auto text-white" style="max-width: 600px;">Bergabunglah dengan ribuan
                            profesional yang telah menguasai keterampilan baru di platform kami. Masa depan Anda dimulai
                            dari sekarang.</p>
                        <div class="d-flex justify-content-center flex-wrap">
                            <a href="{{ route('register') }}"
                                class="btn btn-light btn-lg text-primary font-weight-bold shadow-lg mx-2 mb-3">Mulai
                                Hari Ini</a>
                            <a href="#catalog" class="btn btn-outline-light btn-lg font-weight-bold mx-2 mb-3">Lihat
                                Katalog</a>
                        </div>
                    </div>
                </div>
        ...
        <footer id="about" class="main-footer ml-0 text-center text-md-left">
            <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center">
                ...
                <div>
                    <a href="#" class="btn btn-light btn-sm rounded-circle text-muted mx-1"><i
